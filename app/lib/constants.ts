...
export const features: Feature[] = [
  {
    ...
    description: 'Tailored event planning to match your unique vision and requirements.',
    icon: '🎯'
  },
  {
    name: 'Premium Venues',
    description: 'Access to exclusive venues and locations for any type of event.',
    icon: '🏛️'
  },
  {
    name: 'Expert Team',
    description: 'Experienced professionals handling every detail of your event.',
    icon: '👔'
  },
  {
