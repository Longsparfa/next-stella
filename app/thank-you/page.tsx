    ...
    <div className="bg-white min-h-screen px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
      <div className="max-w-max mx-auto">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-3xl font-[Inter] font-bold tracking-tight text-gray-900 sm:text-5xl">
            Thank you for your booking!
          </h1>
          <p className="mt-6 font-[Poppins] text-base leading-7 text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="mt-16 border-t border-gray-200 pt-8">
          <h2 className="text-sm font-[Inter] font-semibold text-gray-900">Need immediate assistance?</h2>
          <div className="mt-4 flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-auto">
              <div className="text-sm leading-6 text-gray-600">
                <p className="font-[Poppins] font-medium text-gray-900">Call us</p>
                <p className="mt-1 font-[Poppins]">+234 90 2928-6664</p>
              </div>
            </div>
          </div>
        </div>
